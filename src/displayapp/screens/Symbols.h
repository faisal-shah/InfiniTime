  ...
  namespace Applications {
    namespace Screens {
      namespace Symbols {
        ...
        static constexpr const char* envelope = "\xEF\x83\xA0"; // fa-envelope: notifications (bell is the alarm)
        ...
        static constexpr const char* tasks = "\xEF\x82\xAE";    // fa-tasks: checkmarks beside lines
        static constexpr const char* mosque = "\xEF\x99\xB8";   // fa-mosque
        static constexpr const char* calendar = "\xEF\x81\xB3"; // fa-calendar-days
