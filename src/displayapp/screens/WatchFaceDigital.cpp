...
WatchFaceDigital::WatchFaceDigital(Controllers::DateTime& dateTimeController,
  ...
  : currentDateTime {{}},
    ...
    statusIcons(batteryController, bleController, multiAlarmController) {
  ...
  lv_label_set_text_fmt(stepValue, "%s 0", Symbols::shoe);
...
void WatchFaceDigital::Refresh() {
  ...
  if (heartbeat.IsUpdated() || heartbeatRunning.IsUpdated()) {
    if (heartbeatRunning.Get()) {
      lv_obj_set_style_local_text_color(heartbeatIcon, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0xCE1B1B));
      lv_label_set_text_fmt(heartbeatIcon, "%s %d", Symbols::heartBeat, heartbeat.Get());
    } else {
  ...
  if (stepCount.IsUpdated()) {
    lv_label_set_text_fmt(stepValue, "%s %lu", Symbols::shoe, stepCount.Get());
